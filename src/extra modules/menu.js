export function menuPg(){
	...
	function menuItem(imgBox,textBox,srcText,nutrText,itemName,nutrValue,img,imgText,price,priceTxt,imgHeader){
		...
		//burger
		let srcText1 = "../assets/burger.png"
		...
		let srcText2 = "../assets/Hotdog.png"
		...
		//Hotdog
		let srcText3 = "../assets/French_Fries.png"
		...
		//Nuggets
		let srcText4 = "../assets/Nuggets.png"
